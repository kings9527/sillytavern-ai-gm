...
function createCoCCharacter() {
    ...
    attributes.forEach(attr => {
        stats[attr] = Math.floor(Math.random() * 6) + Math.floor(Math.random() * 6) + Math.floor(Math.random() * 6) + 3;
    });
...
function getArkhamNightModule() {
    return {
        ...
        author: 'AI-GM Team',
        system: 'coc',
        description: '一个经典的克苏鲁风格单人调查模组。你在阿卡姆的密斯卡托尼克大学图书馆发现了一本神秘的古籍...',
        start_scene: 'library',
        global_vars: {
            sanity_loss: 0,
            clues_found: 0,
        ...
        scenes: {
            library: {
                id: 'library',
                title: '密斯卡托尼克大学图书馆',
                description: '深夜的图书馆。你独自一人在禁书区。微弱的台灯照亮了积满灰尘的书架。空气中弥漫着旧纸张和霉味。你正在寻找关于阿卡姆近期失踪案的线索。',
            ...
            basement: {
                id: 'basement',
                title: '图书馆地下室',
                description: '狭窄的楼梯通向潮湿的地下室。这里存放着最危险的禁书。你的手电筒光束在黑暗中切割出一道微弱的通道。墙壁上似乎有...奇怪的符号？',
                ...
                exits: [
                    ...
                    { target_scene: 'ritual_chamber', description: '发现隐藏门', condition: { 'clue:basement_secret': true } }
                ],
                combat: {
                    enabled: true,
                    enemies: ['cultist']
            ...
            ritual_chamber: {
                id: 'ritual_chamber',
                title: '秘密仪式室',
                description: '一个巨大的地下洞穴。中央有一个石头祭坛，上面刻满了不可名状的符号。空气中弥漫着硫磺和恐惧的味道。你意识到你已经深入得太远了...',
                world_info_keys: ['ritual', 'elder sign', 'doom'],
                npcs_present: ['cult_leader'],
                exits: [
                    { target_scene: 'madness_ending', description: '面对真相', condition: 'always' }
                ],
                combat: {
                    enabled: true,
            ...
            streets: {
                id: 'streets',
                title: '阿卡姆街道',
                description: '夜晚的街道。雾气弥漫。远处传来狗叫声。你感觉自己被监视了。但也许只是风吹动了树枝...',
            ...
            asylum: {
                id: 'asylum',
                title: '阿卡姆精神病院',
                description: '圣玛丽精神病院的白色走廊。你试图向医生解释你所看到的一切。但你的眼神...你确定你看到的是真的吗？',
            ...
            madness_ending: {
                id: 'madness_ending',
                title: '结局：疯狂',
                description: '你看到了太多。那些符号...那些存在...它们在你的脑海中留下了不可磨灭的印记。SAN CHECK: 1d10/1d100。',
            ...
            sane_ending: {
                id: 'sane_ending',
                title: '结局：理智',
                description: '你选择不去深入。有些知识最好永远不要知道。你回到正常的生活，但那些夜晚...你总会听到呼唤。',
        ...
        npcs: {
            librarian: {
                ...
                name: '亨利·阿米蒂奇',
                role: '图书馆管理员',
                description: '一位年迈的学者，密斯卡托尼克大学的图书管理员。他戴着厚厚的眼镜，动作缓慢但眼神锐利。他似乎知道关于禁书区的某些秘密。',
            ...
            cultist: {
                ...
                name: '邪教徒',
                role: '敌人',
                description: '一个身穿黑袍的人影。他的脸隐藏在兜帽之下。你注意到他的手上有着奇怪的疤痕...那是某种符号。',
            ...
            cult_leader: {
                ...
                name: '神秘领袖',
                role: 'Boss',
                description: '一个高大的身影，站在祭坛前。当他转身时，你看到了一张扭曲的脸...那张脸不属于人类。',
            ...
            doctor_armitage: {
                ...
                name: '弗朗西斯·摩根医生',
                role: '精神病院医生',
                description: '圣玛丽精神病院的资深医生。一位温和但疲惫的中年人。他见过太多"看到不可名状之物"的病人。',
